...
class inference_model(nn.Module):
    ...
    def initialize_node(self, token_level_bert, t2c_tensor, tpool_tensor, graph_tensor):
        ...
        token_level_bert = token_level_bert.view(-1, self.max_len, self.node_dim)
        
        sentence_level = token_level_bert[:, 0:1, :]
        word_level = token_level_concept[:, 1:, :]
        new_inputs = torch.cat([sentence_level, word_level], dim=1)
