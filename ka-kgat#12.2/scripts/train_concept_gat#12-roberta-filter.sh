...
# use micro
NAME=ka-kgat-concept-gat\#12.2.roberta.filter

rm ../checkpoint/$NAME/train_log.txt

 # use concept + gat
CUDA_VISIBLE_DEVICES=9 python train_roberta.py --outdir ../checkpoint/$NAME \
...
CUDA_VISIBLE_DEVICES=9 python test_roberta.py --outdir ./output/ \
