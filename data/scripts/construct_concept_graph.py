...
def add_concept_args(parser):
    ...
    parser.add_argument('--concept_vocab_path', default='data_concepts/concept.txt')
    parser.add_argument('--relation_vocab_path', default='data_concepts/relation.txt')
    parser.add_argument('--c2r_vocab_path', default='data_concepts/conceptnet.en.csv')
