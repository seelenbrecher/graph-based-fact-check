...
# python populate_srl_and_ner_data.py --input ../fever_with_concepts/bert_train_concept.json --source ../srl_and_ner/train.json --output ../fever_srl_and_ner/train.json
