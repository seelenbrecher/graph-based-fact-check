...
# use micro
NAME=ka-kgat-concept-gat\#10.5.8.roberta.snopes-9

rm ../checkpoint/$NAME/train_log.txt

 # use concept + gat
CUDA_VISIBLE_DEVICES=2 python train_roberta.py --outdir ../checkpoint/$NAME \
--train_path ../data/snopes_with_concepts_and_graph_roberta.bk1/train.json \
--valid_path ../data/snopes_with_concepts_and_graph_roberta.bk1/test.json \
...
CUDA_VISIBLE_DEVICES=2 python test_roberta.py --outdir ./output/ \
 --test_path ../data/snopes_with_concepts_and_graph_roberta.bk1/test.json \
 --bert_pretrain ../checkpoint/roberta_large_mlm \
