...
NAME=ka-kgat-concept-gat\#10.5.8.roberta.snopes-1

rm ../checkpoint/$NAME/train_log.txt

 # use concept + gat
CUDA_VISIBLE_DEVICES=5 python train_roberta.py --outdir ../checkpoint/$NAME \
--train_path ../data/snopes_with_concepts_and_graph_roberta.bk/train.json \
--valid_path ../data/snopes_with_concepts_and_graph_roberta.bk/test.json \
...
CUDA_VISIBLE_DEVICES=5 python test_roberta.py --outdir ./output/ \
 --test_path ../data/snopes_with_concepts_and_graph_roberta.bk/test.json \
 --bert_pretrain ../checkpoint/roberta_large_mlm \
...
python ukp_score_test.py --predicted_labels ./output/$NAME-dev.json  --predicted_evidence ../data/bert_eval.json --actual ../data/snopes_with_concepts_and_graph_roberta.bk/test.json
