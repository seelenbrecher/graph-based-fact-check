...
class inference_model(nn.Module):
    ...
    def initialize_node(self, token_level_bert, t2c_tensor, tpool_tensor, graph_tensor):
        ...
        token_level_bert, _, _ = self.span_gat((token_level_bert, edge_indices, rel_indices))
...
class GATLayer(torch.nn.Module):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, relation_num=0, relation_dim=0, concat=True, activation=nn.ELU(),
        ...
        self.rel_proj = nn.Linear(relation_dim, num_of_heads * num_out_features, bias=False)
    ...
    def forward(self, data):
        ...
        #
        in_nodes_features, edge_index, rel_index = data  # unpack data
        ...
        nodes_features_proj_lifted_weighted = nodes_features_proj_lifted * attentions_per_edge
         ...
         # add relation to when propgate. rel * 
        rel_features = self.relation_emb(rel_index)
        rel_features_proj = self.rel_proj(rel_features).view(batch_size, -1, self.num_of_heads, self.num_out_features)
        ...
        return (out_nodes_features, edge_index, rel_index)
