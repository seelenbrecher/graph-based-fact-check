...
class DataLoader(object):
    ...
    def next(self):
        ...
        if self.step < self.total_step:
            ...
            claim_path_masks_tensor_input = Variable(torch.LongTensor(claim_srl_input[3]))
            ...
            evi_path_masks_tensor_input = Variable(torch.LongTensor(evi_srl_input[3]))
            ...
            if self.cuda:
                ...
                claim_path_masks_tensor_input = claim_path_masks_tensor_input.cuda()
                ...
                evi_path_masks_tensor_input = evi_path_masks_tensor_input.cuda()
            ...
            claim_srl_inp_tensor = (claim_masks_tensor_input, claim_tags_tensor_input, claim_paths_tensor_input, claim_path_masks_tensor_input)
            evi_srl_inp_tensor = (evi_masks_tensor_input, evi_tags_tensor_input, evi_paths_tensor_input, evi_path_masks_tensor_input)
